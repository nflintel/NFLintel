    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-2xl overflow-hidden border border-border-base dark:border-white/10"
        >
          <div className="p-8 space-y-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="nike-text text-2xl dark:text-white">Theme Lab</h2>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Custom Variables</p>
                </div>
              </div>
              <button 
                onClick={onClose}
                className="p-2 hover:bg-bg-surface dark:hover:bg-zinc-800 rounded-full transition-colors"
              >
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full border-2 border-white dark:border-zinc-800 shadow-sm transition-transform hover:scale-110"
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-3">
                  ...
                  <input 
                    ...
                    value={formData.primaryColor}
                    onChange={(e) => handleChange('primaryColor', e.target.value)}
                    className="flex-1 bg-bg-surface dark:bg-zinc-950 border border-border-base dark:border-white/10 rounded-xl px-4 text-sm font-mono dark:text-white focus:outline-none focus:border-black dark:focus:border-white transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <select 
                    ...
                    className="text-[10px] uppercase tracking-widest font-bold bg-transparent border-none text-emerald-500 outline-none cursor-pointer dark:bg-zinc-900"
                  >
                ...
                <input 
                  ...
                  className="w-full bg-bg-surface dark:bg-zinc-950 border border-border-base dark:border-white/10 rounded-xl px-4 py-3 text-sm font-medium dark:text-white focus:outline-none focus:border-black dark:focus:border-white transition-all"
                  placeholder="Inter, sans-serif"
                />
                <div 
                  className="p-4 mt-2 bg-slate-50 dark:bg-zinc-950/50 rounded-xl border border-slate-100 dark:border-zinc-800/50"
            ...
            <div className="flex gap-4 pt-4">
              <button 
                onClick={handleReset}
                className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl bg-bg-surface dark:bg-zinc-800 text-slate-600 dark:text-zinc-400 text-[10px] font-bold uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-zinc-700 transition-all"
              >
              ...
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl bg-black dark:bg-white text-white dark:text-black text-[10px] font-bold uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl"
              >
